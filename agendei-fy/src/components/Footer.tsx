...
const Footer = ({ className }: FooterProps) => {
  ...
  return (
    <footer className={`bg-gray-50/80 backdrop-blur-sm border-t mt-auto relative ${className || ''}`}>
      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Simplifique seu agendamento e potencialize seu negócio.
            </motion.p>
            <motion.div 
          ...
          <div className="col-span-1">
            <motion.h3 
              className="text-base font-semibold text-gray-800 mb-4 uppercase tracking-wider"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
        ...
        >
          <p className="text-gray-500 text-sm">
            © {currentYear} Agendeify. Todos os direitos reservados.
          </p>
